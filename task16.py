...
# Рассматриваем сортировку по возрасту. Я бы в каждом словаре сравнивал заданной значений со значением ключа 'age'
# если значение 'age'>заданного то выводить весь словарь
